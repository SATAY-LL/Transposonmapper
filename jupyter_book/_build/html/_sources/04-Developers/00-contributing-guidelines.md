...
1. use the search functionality [here](https://github.com/SATAY-LL/Transposonmapper/issues) to see if someone already filed the same issue;
...
1. [push](http://rogerdudler.github.io/git-guide/>) your feature branch to (your fork of) the transposonmapper repository on GitHub;
